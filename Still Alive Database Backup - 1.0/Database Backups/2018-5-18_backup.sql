...
--
-- Host: localhost:3306
-- Generation Time: May 18, 2018 at 10:14 AM
...
(10, 9, 'Commander Davis', '2017-05-01', 1, NULL, 21, 2, 0, 26, 1, 50, 40, 10, 1, 1, '**See &#34;The Story&#34; section of the Still Alive Handbook to see the backstory of Richard Gantz and Commander Davis.**', 1, 1, 1, 1, 1, 1, 0, 1, 0, 0, 0),
...
(4, '2018-05-18', '2018-05-18', '09:53:36', '09:55:03', 0, 'Practice and Refresher Event', 'Version 1.2 was released. We want a practice event to get everyone acquainted to the new rules, show the new players how to play, and get everyone stoked for this season of Still Alive!');
...
(9, 'rcraker', 'Rydge Craker', '2017-04-30', 99988, 4, 0, 4, 0, '2018-05-17', 99989),
...
('root', '[{\"db\":\"StillAlive\",\"table\":\"Skills\"},{\"db\":\"StillAlive\",\"table\":\"Characters\"},{\"db\":\"StillAlive\",\"table\":\"Players\"},{\"db\":\"StillAlive\",\"table\":\"EventAttendees\"},{\"db\":\"StillAlive\",\"table\":\"Events\"},{\"db\":\"StillAlive\",\"table\":\"HistoricalEvents\"},{\"db\":\"StillAlive\",\"table\":\"Items\"}]');
...
--
ALTER TABLE `HistoricalEvents`
  MODIFY `historyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
...
--
ALTER TABLE `Players`
  MODIFY `playerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
